...
const std::unordered_map<LocaleConstant, std::string> AB_WELCOME_TO_PLAYER = {
    {LOCALE_enUS, "|cffc3dbff [AutoBalance]|r|0xFFFF00 Welcome to {} ({}-player {}). There are {} player(s) in this instance. Difficulty set to {} player(s).|r"},
    {LOCALE_koKR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} ({}-player {})에 오신 것을 환영합니다. 이 인스턴스에는 {}명의 플레이어가 있습니다. 난이도가 {}명으로 설정되었습니다.|r"},
    {LOCALE_frFR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 Bienvenue dans {} ({} {}). Il y a {} joueur(s) dans cette instance. La difficulté est réglée sur {} joueur(s).|r"},
    {LOCALE_deDE, "|cffc3dbff [AutoBalance]|r|0xFFFF00 Willkommen in {} ({} Spieler {}). Es gibt {} Spieler in dieser Instanz. Schwierigkeit auf {} Spieler eingestellt.|r"},
    {LOCALE_zhCN, "|cffc3dbff [弹性副本]|r|0xFFFF00 欢迎来到 {}（{}人（{}））。副本中共有 {} 名玩家。副本难度设置为 {} 人。|r"},
    {LOCALE_zhTW, "|cffc3dbff [AutoBalance]|r|0xFFFF00 歡迎來到 {}（{}人 {}）。此副本中有 {} 名玩家。難度設定為 {} 名玩家。|r"},
    {LOCALE_esES, "|cffc3dbff [AutoBalance]|r|0xFFFF00 Bienvenido a {} ({} jugador {}). Hay {} jugador(es) en esta instancia. La dificultad se establece en {} jugador(es).|r"},
    {LOCALE_esMX, "|cffc3dbff [AutoBalance]|r|0xFFFF00 Bienvenido a {} ({} jugador {}). Hay {} jugador(es) en esta instancia. La dificultad se establece en {} jugador(es).|r"},
    {LOCALE_ruRU, "|cffc3dbff [AutoBalance]|r|0xFFFF00 Добро пожаловать в {} ({} игрок {}). В этом экземпляре {} игроков. Сложность установлена на {} игроков.|r"},
};
...
const std::unordered_map<LocaleConstant, std::string> AB_ANNOUNCE_NON_GM_ENTERING_INSTANCE = {
    {LOCALE_enUS, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} enters the instance. There are {} player(s) in this instance. Difficulty set to {} player(s).|r"},
    {LOCALE_koKR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {}이(가) 인스턴스에 들어왔습니다. 이 인스턴스에는 {}명의 플레이어가 있습니다. 난이도가 {}명으로 설정되었습니다.|r"},
    {LOCALE_frFR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} entre dans l'instance. Il y a {} joueur(s) dans cette instance. La difficulté est réglée sur {} joueur(s).|r"},
    {LOCALE_deDE, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} betritt die Instanz. Es gibt {} Spieler in dieser Instanz. Schwierigkeit auf {} Spieler eingestellt.|r"},
    {LOCALE_zhCN, "|cffc3dbff [弹性副本]|r|0xFFFF00 {} 进入了副本。当前副本内共有 {} 名玩家。副本难度设置为 {} 人。"},
    {LOCALE_zhTW, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {}進入了副本。此副本中有 {} 名玩家。難度設定為 {} 名玩家。|r"},
    {LOCALE_esES, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} entra en la instancia. Hay {} jugador(es) en esta instancia. La dificultad se establece en {} jugador(es).|r"},
    {LOCALE_esMX, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} entra en la instancia. Hay {} jugador(es) en esta instancia. La dificultad se establece en {} jugador(es).|r"},
    {LOCALE_ruRU, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} входит в экземпляр. В этом экземпляре {} игроков. Сложность установлена на {} игроков.|r"},
};

const std::unordered_map<LocaleConstant, std::string> AB_LEAVING_INSTANCE_COMBAT = {
    {LOCALE_enUS, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} left the instance while combat was in progress. Difficulty locked to no less than {} players until combat ends.|r"},
    {LOCALE_koKR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {}이(가) 전투 중에 인스턴스를 떠났습니다. 전투가 끝날 때까지 난이도가 {}명 미만으로 잠겨 있습니다.|r"},
    {LOCALE_frFR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} a quitté l'instance alors que le combat était en cours. La difficulté est verrouillée à pas moins de {} joueur(s) jusqu'à la fin du combat.|r"},
    {LOCALE_deDE, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} hat die Instanz verlassen, während der Kampf im Gange war. Die Schwierigkeit ist gesperrt, bis der Kampf endet, auf nicht weniger als {} Spieler.|r"},
    {LOCALE_zhCN, "|cffc3dbff [弹性副本]|r|0xFFFF00 {} 在战斗中离开了副本。战斗结束前，难度将保持不少于 {} 人。|r"},
    {LOCALE_zhTW, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {}在戰鬥進行中離開了副本。直到戰鬥結束，難度鎖定為不少於 {} 名玩家。|r"},
    {LOCALE_esES, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} salió de la instancia mientras el combate estaba en progreso. La dificultad está bloqueada a no menos de {} jugador(es) hasta que termine el combate.|r"}
};

const std::unordered_map<LocaleConstant, std::string> AB_LEAVING_INSTANCE = {
    {LOCALE_enUS, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} left the instance. There are {} player(s) in this instance. Difficulty set to {} player(s).|r"},
    {LOCALE_koKR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {}이(가) 인스턴스를 떠났습니다. 이 인스턴스에는 {}명의 플레이어가 있습니다. 난이도가 {}명으로 설정되었습니다.|r"},
    {LOCALE_frFR, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} a quitté l'instance. Il y a {} joueur(s) dans cette instance. La difficulté est réglée sur {} joueur(s).|r"},
    {LOCALE_deDE, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} hat die Instanz verlassen. Es gibt {} Spieler in dieser Instanz. Schwierigkeit auf {} Spieler eingestellt.|r"},
    {LOCALE_zhCN, "|cffc3dbff [弹性副本]|r|0xFFFF00 {} 离开了副本。当前副本中有 {} 名玩家。难度设置为 {} 人。|r"},
    {LOCALE_zhTW, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {}離開了副本。此副本中有 {} 名玩家。難度設定為 {} 名玩家。|r"},
    {LOCALE_esES, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} salió de la instancia. Hay {} jugador(es) en esta instancia. La dificultad se establece en {} jugador(es).|r"},
    {LOCALE_esMX, "|cffc3dbff [AutoBalance]|r|0xFFFF00 {} salió de la instancia. Hay {} jugador(es) en esta instancia. La dificultad se establece en {}"}
};
...
const std::unordered_map<LocaleConstant, std::string> AB_SET_OFFSET_COMMAND_DESCRIPTION = {
    ...
    {LOCALE_zhCN, "设置此副本的玩家难度偏移。例：(你 + offset(1) = 2 人)。用法：.ab offset <数字>。|r"},
...
const std::unordered_map<LocaleConstant, std::string> AB_ADJUSTED_PLAYER_COUNT_MAP_MINIMUM_DIFFICULTY_OFFSET = {
    ...
    {LOCALE_zhCN, "调整后玩家数量：{}（副本最低限制 + 难度偏移 {}）|r"},
...
const std::unordered_map<LocaleConstant, std::string> AB_WORLD_HOSTILE_DAMAGE_HEALING_MULTIPLIER_TO = {
    ...
    {LOCALE_zhCN, "全局敌对伤害和治疗系数：%.3f -> %.3f|r"},
...
const std::unordered_map<LocaleConstant, std::string> AB_XP_MONEY_MULTIPLIER = {
    ...
    {LOCALE_zhCN, "经验值系数：%.3f  金钱系数：%.3f|r"},
